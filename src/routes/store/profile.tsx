  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="flex items-center gap-3">
        <Link to="/store">
          <Button variant="ghost" size="sm"><ArrowLeft className="mr-1 h-4 w-4" /> Back to Shop</Button>
        </Link>
      ...
      <form onSubmit={handleSave} noValidate className="space-y-5">
        ...
        <div className="rounded-xl border bg-card p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input id="p-name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Jane Smith" />
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input id="p-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" className="pl-9" />
            </div>
        ...
        <div className="rounded-xl border bg-card p-6 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Input id="new-pw" type="password" value={newPw} onChange={(e) => setNewPw(e.target.value)} placeholder="Min. 8 characters" />
              {errors.newPw && <p className="text-xs text-destructive">{errors.newPw}</p>}
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="conf-pw">Confirm New Password</Label>
              <Input id="conf-pw" type="password" value={confirmPw} onChange={(e) => setConfirmPw(e.target.value)} placeholder="Repeat password" />
